...
function Navigation() {
    return (
        <Navbar fluid rounded className='px-10 font-custom bg-white xl:px-20'>
            <NavbarBrand>
                <Link to="/" exact className="mr-3 mt-3 h-6 sm:h-9 text-primaryTextDark font-bold"> Adewale O. Obadina </Link>
            </NavbarBrand>
            <NavbarToggle />
            <NavbarCollapse className='m-4 font-bold'>
                ...
                <NavLink to="/publications" className='mt-3 text-primaryTextDark'> Publication </NavLink>
