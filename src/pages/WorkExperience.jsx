    ...
    return (
        <div className="font-custom">
            ...
            <div className="bg-cover bg-center bg-no-repeat bg-gray-700 bg-blend-multiply text-center py-40" style={{ backgroundImage: 'url(/work.jpg)', height: '350px' }}>
                <h3 className="mb-4 text-cm font-extrabold tracking-tight text-white md:text-5xl lg:text-6xl"> Work experience </h3>
                <p className="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16  lg:px-48  md:text-center ">Experiences Dr. Obadina gained over the years.  </p>
            </div>

            <div className='py-8'>
                {/* Work Experience 1  */}
                <div className='px-8'>
                    <h4 className='py-4 text-cm font-extrabold text-primaryGreen'> Academic Experience </h4>
                    <li className='py-2'>
                ...
                <div className='px-8'>
                    {/* Number 1  */}
                    <h4 className='py-4 text-cm font-extrabold text-primaryGreen'> Administrative Experience
                    </h4>
                ...
                <div className='px-8'>
                    <h4 className='py-4 text-cm font-extrabold text-primaryGreen'> Professional / Research Experience </h4>
                    <li className='py-2'>
